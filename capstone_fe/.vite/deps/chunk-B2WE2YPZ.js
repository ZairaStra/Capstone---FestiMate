    ...
    (function () {
      ...
      function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
          ...
          isArrayImpl(callback)
            ...
            : null != callback &&
              (isValidElement(callback) &&
                (null != callback.key && ((invokeCallback && invokeCallback.key === callback.key) || checkKeyStringCoercion(callback.key)),
        ...
        if (isArrayImpl(children))
          ...
          for (
            i === children.entries &&
              (didWarnAboutMaps || console.warn("Using Maps as children is not supported. Use an array of keyed ReactElements instead."),
      ...
      function recursivelyFlushAsyncActWork(returnValue, resolve, reject) {
        ...
        0 < ReactSharedInternals.thrownErrors.length
          ? ((queue = aggregateErrors(ReactSharedInternals.thrownErrors)), (ReactSharedInternals.thrownErrors.length = 0), reject(queue))
          : resolve(returnValue);
      }
            ...
            then: function (resolve, reject) {
              ...
              thenable.then(
                ...
                function (error) {
                  popActScope(prevActQueue, prevActScopeDepth);
                  0 < ReactSharedInternals.thrownErrors.length
                    ? ((error = aggregateErrors(ReactSharedInternals.thrownErrors)), (ReactSharedInternals.thrownErrors.length = 0), reject(error))
                    : reject(error);
                }
              );
            },
